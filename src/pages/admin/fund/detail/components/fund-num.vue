<template>
  <a-grid :cols="{ xs: 2, sm: 2, md: 2, lg: 4, xl: 4, }" :colGap="20" :rowGap="16" style="width: 100%">
    <a-space class="panel">
      ...
      <a-statistic title="总金额" :value="parseInt(statistics.totalFund)" >
    ...
    <a-space class="panel">
      ...
      <a-statistic title="待分配" :value="parseInt(statistics.left)" :value-from="0" animation>
      </a-statistic>
    </a-space>
    <a-space class="panel">
      <a-avatar :size="55" style="background-color: var(--color-fill-2);">
      ...
      <a-statistic title="已使用" :value="parseInt(statistics.used)" :value-from="0" animation>
      </a-statistic>
    </a-space>
    <a-space class="panel">
      <a-avatar :size="55" style="background-color: var(--color-fill-2);">
      ...
      <a-statistic title="完成率" :value="parseInt(statistics.completeRate)" :value-from="0" animation>
